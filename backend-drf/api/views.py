...
class StockPredictionAPIView(APIView):
    def post(self, request):
        serialzer = StockPredictionSerialzer(data=request.data)
        if serialzer.is_valid():
            ...
            # Scale down data between 0 and 1
            ...
            y_predicted = scaler.inverse_transform(y_prdicted.reshape(-1, 1)).flatten()
